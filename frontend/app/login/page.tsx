...
import { User, Lock, ArrowRight, ShieldCheck, Baby, ArrowLeft } from "lucide-react";
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input type="text" placeholder="000.000.000-00" className="w-full pl-12 pr-4 py-4 bg-gray-50 border-2 border-gray-100 rounded-xl focus:border-primary focus:bg-white outline-none transition-all"/>
                  </div>
                </div>
                ...
                <button 
                  type="submit" 
                  className="w-full bg-accent hover:bg-orange-500 text-white font-bold py-4 rounded-xl shadow-lg transition-transform hover:-translate-y-1 flex items-center justify-center gap-2 cursor-pointer"
                >
              ...
              <div className="space-y-4">
                <Link href="/admin/dashboard" className="block w-full">
                  <div className="p-4 border-2 border-gray-100 rounded-2xl hover:border-primary hover:bg-purple-50 transition flex items-center gap-4 group">
                    ...
                    <div className="text-left">
                       <h3 className="font-bold text-gray-800">Gestão Escolar</h3>
                       <p className="text-xs text-gray-500">Acesso administrativo</p>
                    </div>
                  </div>
                </Link>
                ...
                <Link href="/agenda" className="block w-full">
                  <div className="p-4 border-2 border-gray-100 rounded-2xl hover:border-accent hover:bg-orange-50 transition flex items-center gap-4 group">
                    <div className="bg-accent/10 p-3 rounded-full text-accent group-hover:bg-accent group-hover:text-white transition">
                      <Baby size={28} />
                    </div>
                    <div className="text-left">
                       <h3 className="font-bold text-gray-800">Responsável</h3>
                       <p className="text-xs text-gray-500">Ver agenda e avisos</p>
                    </div>
                  </div>
                </Link>
              </div>
